  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        {/* Blob background placed here to ensure it's behind content */}
        <motion.div 
        ...
        <motion.div 
          className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-sm text-gray-400 hidden md:flex"
