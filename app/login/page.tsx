        ...
        <div className="min-h-screen flex items-center justify-center pt-20 pb-20">
          <div className="max-w-md w-full p-8 bg-black/50 backdrop-blur-md rounded-xl border border-mint/20">
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3" role="group" aria-label="Social sign in options">
                <button 
                  type="button"
                  className="flex justify-center items-center py-2.5 px-4 border border-gray-700 rounded-md hover:bg-gray-900 transition-colors focus:outline-none focus:ring-2 focus:ring-mint/50"
                  aria-label="Sign in with Google"
                >
                  <svg className="h-5 w-5 text-gray-400" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
